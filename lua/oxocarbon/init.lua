...
vim.api.nvim_set_hl(0, "Error", { fg = error, bg = oxocarbon.base01 })
...
vim.api.nvim_set_hl(0, "DiagnosticError", { fg = error, bg = oxocarbon.none })
...
vim.api.nvim_set_hl(0, "DiagnosticUnderlineError", { fg = error, bg = oxocarbon.none, undercurl = true })
...
vim.api.nvim_set_hl(0, "HealthError", { fg = error, bg = oxocarbon.none })
...
vim.api.nvim_set_hl(0, "Directory", { fg = base06, bg = oxocarbon.none })
vim.api.nvim_set_hl(0, "EndOfBuffer", { fg = oxocarbon.base01, bg = oxocarbon.none })
vim.api.nvim_set_hl(0, "ErrorMsg", { fg = error, bg = oxocarbon.none })
...
vim.api.nvim_set_hl(0, "@punctuation.delimiter", { fg = "#FAFAFA", bg = oxocarbon.none })
-- vim.api.nvim_set_hl(0, "@punctuation.delimiter", { fg = oxocarbon.base08, bg = oxocarbon.none })
vim.api.nvim_set_hl(0, "@punctuation.bracket", { fg = "#FAFAFA", bg = oxocarbon.none })
...
vim.api.nvim_set_hl(0, "@keyword", { fg = oxocarbon.base08, bg = oxocarbon.none })
vim.api.nvim_set_hl(0, "@keyword", { fg = oxocarbon.base11, bg = oxocarbon.none })
vim.api.nvim_set_hl(0, "@keyword.function", { fg = oxocarbon.base07, bg = oxocarbon.none })
...
vim.api.nvim_set_hl(0, "@include", { fg = oxocarbon.base09, bg = oxocarbon.none })
vim.api.nvim_set_hl(0, "@exception", { fg = error, bg = oxocarbon.none })
...
vim.api.nvim_set_hl(0, "@property", { fg = oxocarbon.base05, bg = oxocarbon.none })
...
vim.api.nvim_set_hl(0, "NvimInternalError", { fg = error, bg = oxocarbon.base08 })
...
vim.api.nvim_set_hl(0, "StatusLineDiagnosticError", { fg = error, bg = oxocarbon.base00, bold = true })
